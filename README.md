# ☕ **Staking-Contract-Core** Smart Contract

A straightforward smart contract enabling staking functionality on the Core Blockchain. Built with Solidity.
...
```bash
git clone https://github.com/Arwa-ghasletwala/Staking-Contract-Core.git
cd Staking-Contract-Core
```
